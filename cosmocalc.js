...
function Cosmos(inp){
	...
	this.H0 = 69.7;	// Hubble constant
	this.WM = 0.2820;	// Omega(matter)
	this.WV = 0.7181;	// Omega(vacuum) or lambda
	this.WR = 0;	// Omega(radiation)
	this.WK = 0;	// Omega curvature = 1 - Omega(total)
...
CosmoCalc.prototype.displayTableHeader = function() {
	var str = "<tr>";
	str += "<th><a href=\"http://www.astro.ucla.edu/~wright/glossary.html#redshift\">z</a></th>";
	if(this.H0changed) str += "<th><a href=\"http://www.astro.ucla.edu/~wright/glossary.html#H0\">H<sub>o</sub></a></th>";
	if(this.WMchanged) str += "<th><a href=\"http://www.astro.ucla.edu/~wright/glossary.html#Omega\">&Omega;<sub>M</sub></a></th>";
	if(this.WVchanged) str += "<th><a href=\"http://www.astro.ucla.edu/~wright/glossary.html#CC');\" href=\"#\">&Omega;<sub>vac</sub></a></th>";
	str += "<th>Age at z=0 (t<sub>H</sub>)</th>";
	str += "<th>Age at redshift z</th>";
	str += "<th><a href=\"http://www.astro.ucla.edu/~wright/cosmo_02.htm#DT\">Light travel time</a></th>";
	str += "<th><a href=\"http://www.astro.ucla.edu/~wright/cosmo_02.htm#DH\">Comoving radial distance</a></th>";
	str += "<th>Comoving volume within redshift z</th>";
	str += "<th>Angular size distance (D<sub>A</sub>)</th>";
	str += "<th>Scale</th>";
	str += "<th><a href=\"http://www.astro.ucla.edu/~wright/cosmo_02.htm#DL\">Luminosity distance (D<sub>L</sub>)</a></th>";
	str += "</tr>";
...
function doReplaceHWV(ccvar){ c.doReplaceHWV(ccvar); }
// function doWMAP7(){ c.doReplaceHWV("WMAP7"); }
// function doWMAP9(){ c.doReplaceHWV("WMAP9"); }

CosmoCalc.prototype.doReplaceHWV = function(cosmology) {
...
CosmoCalc.prototype.do = function(curvature) {
	...
	for(var i = 0 ; i < zlist.length ; i++){
		...
		if(zlist[i]){
			...
			H0 = parseFloat(H0list.length > i ? H0list[i] : H0list[H0list.length - 1]);
			WM = parseFloat(WMlist.length > i ? WMlist[i] : WMlist[WMlist.length - 1]);
